...
class TkinterConsole(Frame):
    def __init__(self, master):
        ...
        execution_time = timeit.timeit(number=1)
...
class App:
    def __init__(self):
        ...
        self.root.title('SIMP - Secure Information Managment platform')
    ...
    def __render_screen(self):
        ...
        btn_quit = Button(self.root, text='Encrypt Launcher', command=self.root.destroy, padx=10, pady=3, relief='groove', bg='#ffe0b2')
...
"""
    Name: Encryption
    Type: SIMP - File Encryption GUI App 
...
class MainWindow:
    ...
    def __init__(self, root):
        ...
        root.title("SIMP- File Encryption")
...
3. Click ENCRYPT Button to encrypt. A new encrypted file with ".simp" extention e.g. "abc.jpg.simp" will be created in the same directory where the "abc.jpg" is.
4. When you want to Decrypt a file you, will select the file with the ".simp" extention and Enter your Secret Key which you chose at the time of Encryption. Click DECRYPT Button to decrypt. The decrypted file will be of the same name as before with the suffix "__dekrypted__" e.g. "abc__dekrypted__.jpg".
